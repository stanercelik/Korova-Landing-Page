...
function InputButtonAction({ className, ...props }: InputButtonActionProps) {
  ...
  return (
    <motion.button
      ...
      className={cn(
        'bg-background text-sm whitespace-nowrap disabled:pointer-events-none disabled:opacity-50 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive rounded-full border text-foreground cursor-pointer pl-4 pr-12 size-full font-medium',
        className,
      )}
